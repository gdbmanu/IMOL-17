...
{\color{Purple}Maximizing the Saliency is here interpreted as choosing the most optimistic (and ``risky'') information gain approximation, that links with exploratory behavior.}
