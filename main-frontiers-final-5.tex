...
\begin{figure}
	...
	\vspace{-.2cm}
	\caption{\textbf{Method comparisons}. \textbf{a}. Objective functions  comparison in a faulty model (see  fig.~\ref{fig:foveated-saccades}).  \textbf{b}. Information Gain-based computational schemes compared on the baseline model. \textbf{c}. Information Gain-based computational schemes compared on the faulty model. The recognition threshold varies from $H_\text{ref}=10^{-5}$ up to  $H_\text{ref}=10^{-1}$ (from left to right).}\label{fig:failed}
\end{figure}
